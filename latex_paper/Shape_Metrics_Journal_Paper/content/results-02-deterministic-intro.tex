...
Our high-level goal is to characterize the extent to which these $K$ neural systems are similar to or different from each other across these measurement points.
